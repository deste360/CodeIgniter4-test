...
<head>
    ...
    <!-- STYLES -->
    <link href="/assets/components.css" rel="stylesheet" id="style_components" type="text/css" />
</head>
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Docs</a>
                </li>
                <li class="menu-item"><a href="https://forum.codeigniter.com/" target="_blank">Community</a></li>
                <li class="menu-item"><a
                    href="<?=site_url('logout');?>">Logout <?=user()->firstname??user()->username;?></a>
                </li>
            </ul>
        </div>
    ...
    <section>
        ...
        <p>
            Current CI env setting <i>baseURL</i> is: <b><?=$base_url;?></b><br />
            <i>Environment</i> is: <b><?=$environment;?></b><br />
            <i>SMTP server</i> is: <b><?=$SMTPHost;?></b>
        </p>
        ...
        <?php if (! empty($last_logins) && is_array($last_logins)) : ?>

            <ul>
                <?php foreach($last_logins as $r) { ?>
                    <li><?=$r->email.' logged in on '.$r->date;?></li>
                <?php } ?>
            </ul>
